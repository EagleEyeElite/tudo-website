 ...
 * @return void
 */
function update_acf_background_for_attachment($attachment_id, $value) {
    ...
    if ($success) {
        echo "Successfully updated 'background' field for attachment ID {$attachment_id}.\n";
    } else {
        echo "Failed to update 'background' field for attachment ID {$attachment_id}.\n";
    }
}
...
update_acf_background_for_attachment($attachment_id, $value);